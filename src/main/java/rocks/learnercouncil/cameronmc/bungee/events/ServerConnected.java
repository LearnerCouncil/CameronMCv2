...
import rocks.learnercouncil.cameronmc.bungee.util.ConnectionQueue;
...
public class ServerConnected implements Listener {
    ...
    public static HashMap<ProxiedPlayer, ConnectionQueue> queuedPlayers = new HashMap<>();
    ...
    public void onServerConnected(ServerConnectedEvent e) {
        for(ProxiedPlayer p : queuedPlayers.keySet()) {
            if(p.getUniqueId().equals(e.getPlayer().getUniqueId())) {
                ...
                queuedPlayers.get(p).fireQueued();
